 ...
 * @program Add/Insert an element to an already sorted Singly Linked List
 * @study http://www.geeksforgeeks.org/given-a-linked-list-which-is-sorted-how-will-you-insert-in-sorted-way/
 */
public class AddToSortedLinkedList {
	...
	public static void main(String[] args) {
		...
		// New empty list
		AddToSortedLinkedList newList = new AddToSortedLinkedList(); // This will give me head
		// node which is not
